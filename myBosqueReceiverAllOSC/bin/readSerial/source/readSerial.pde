...
float timeBetweenReadsFastData = 0.4;
...
//------------------------------------------
void tryOpenLastSerialPortAvailable() {
...
void serialEvent  (Serial myPort) {
  ...
  if (pBat>=0) {
    ...
    batVal = float(trim(auxFilterVal));
  ...
  if (pNoise>=0) {
    ...
    if (bInfoRaw)println(auxFilterVal);
    noiseVal = float(trim(auxFilterVal));
  ...
  if (pHumidity>=0) {
    ...
    if (bInfoRaw)println(auxFilterVal);
    humVal = float(trim(auxFilterVal));
  ...
  if (pTemperature>=0) {
    ...
    if (bInfoRaw)println(auxFilterVal);
    tempVal = float(trim(auxFilterVal));
  ...
  if (pLight>=0) {
    ...
    if (bInfoRaw)println(auxFilterVal);
    lightVal = float(trim(auxFilterVal));
  ...
  if (pVoc>=0) {
    ...
    VOCVal = float(trim(auxFilterVal));
  ...
  if (pCO2>=0) {
    ...
    if (false)print("CO2: ");
    if (false)println(auxFilterVal);
    CO2Val = float(trim(auxFilterVal));
